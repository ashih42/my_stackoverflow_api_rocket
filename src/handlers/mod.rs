...
pub async fn create_question(
    ...
    let question = handlers_inner::create_question(question.into_inner(), questions_dao).await?;
...
pub async fn create_answer(
    ...
    let answer = handlers_inner::create_answer(answer.into_inner(), answers_dao).await?;
